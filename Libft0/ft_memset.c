...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/13 18:28:57 by oduran-m          #+#    #+#             */
/*   Updated: 2026/01/13 18:31:53 by oduran-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdio.h>
#include <string.h>
...
/*int main(void) {
    char buffer[10]; // Reserva espacio para 10 char 
    ...
    printf("Después de ft_memset(data, 0, sizeof(data)): '%s' 
	(longitud %zu)\n", data, strlen(data)); 
	// Salida: '' (cadena vacía, longitud 0)

    // 3. ¡Cuidado con desbordamientos!
    char small_buffer[3];
    ft_memset(small_buffer, 'X', 10); 
	// ¡ERROR! Intentar escribir fuera de la memoria reservada.
