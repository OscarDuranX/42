...
def test_healing_family(factory: HealingCreatureFactory) -> None:
...
def test_transform_family(factory: TransformCreatureFactory) -> None:
...
def main() -> None:
    ...
    test_healing_family(healing_factory)
    print()
    test_transform_family(transform_factory)
